...
TEST_F(trovaLibre_test_fixture, initial_state) {
...
TEST_F(trovaLibre_test_fixture, loop_takes_cycleTime) {
...
TEST_F(trovaLibre_test_fixture, sunny_day_play) {
...
TEST_F(trovaLibre_test_fixture, admin_in_idle) {
...
TEST_F(trovaLibre_test_fixture, admin_in_play) {
...
TEST_F(trovaLibre_test_fixture, admin_in_pause) {
...
// =================== shutdown (idle, pause)
TEST_F(trovaLibre_test_fixture, shutdown_in_idle) {
...
TEST_F(trovaLibre_test_fixture, shutdown_in_pause) {
...
TEST_F(trovaLibre_test_fixture, shortcutx_in_idle) {
...
TEST_F(trovaLibre_test_fixture, shortcutx_in_pause) {
...
TEST_F(trovaLibre_test_fixture, shortcut3x3_in_idle) {
  ...
  for (uint8_t index = 0; index < Buttons3x3::numLevels; ++index) {
    ...
    ASSERT_TRUE(SM_trovaLibre::is_in_state<StartPlay<Play>>()) << index;
...
TEST_F(trovaLibre_test_fixture, shortcut3x3_in_pause) {
...
TEST_F(trovaLibre_test_fixture, shortcut3x3_in_play) {
...
// =================== pause (pause, play)
TEST_F(trovaLibre_test_fixture, pause_in_pause) {
  goto_pause({ 4, pmode_t::album, 0, 0 });
  Print::clear_output();
...
TEST_F(trovaLibre_test_fixture, pause_in_play) {
...
// =================== track (play)
TEST_F(trovaLibre_test_fixture, track_in_play) {
...
// =================== volume_up/down (play)
TEST_F(trovaLibre_test_fixture, volume_up_down_in_play) {
  goto_play({ 4, pmode_t::album, 0, 0 });
  Print::clear_output();
...
// =================== next/previous (play)
TEST_F(trovaLibre_test_fixture, next_previous_in_play) {
...
// =================== next/previous (play)
TEST_F(trovaLibre_test_fixture, next_previous_in_admin) {
  goto_admin();
  Print::clear_output();
...
// =================== next/previous (play)
TEST_F(trovaLibre_test_fixture, select_in_admin) {
  goto_admin();
  Print::clear_output();
  ...
  EXPECT_TRUE(SM_trovaLibre::is_in_state<Admin_InvButtons>());
  execute_cycle_for_ms(time_check_play);
  EXPECT_TRUE(getMp3().is_playing_mp3());
...
// =================== next/previous (play)
TEST_F(trovaLibre_test_fixture, adm_end_in_admin) {
  goto_admin();
  Print::clear_output();
...
// =================== volume
TEST_F(trovaLibre_test_fixture, volume_settings) {
...
// =================== standbyTimer
TEST_F(trovaLibre_test_fixture, standbyTimer_settings) {
...
// =================== adminMenuL
TEST_F(trovaLibre_test_fixture, adminMenu_settings) {
...
TEST_F(trovaLibre_test_fixture, pauseWhenCardRemoved_settings) {
...
// =================== card out in play
TEST_F(trovaLibre_test_fixture, pause_if_card_removed_works) {
  ...
  for (folderSettings card: test_data) {
    ...
    // card out --> pause
    card_out();
    ASSERT_TRUE(SM_trovaLibre::is_in_state<Pause>()) << "Index: " << ind;
    execute_cycle();
    EXPECT_TRUE(getMp3().is_pause());

    // card in --> play
    card_in(card, track_count);
    ASSERT_TRUE(SM_trovaLibre::is_in_state<Play>()) << "Index: " << ind;
    execute_cycle_for_ms(time_check_play);
    ASSERT_TRUE(getMp3().is_playing_folder()) << "Index: " << ind;
    EXPECT_EQ(getMp3().df_folder, card.folder);
...
TEST_F(trovaLibre_test_fixture, pause_if_card_removed_card_out_early) {
...
TEST_F(trovaLibre_test_fixture, pause_if_card_removed_card_in_with_other) {
  card_data_2 test_data[] = {
      ...
      {
          { 1, pmode_t::audio_play_range, 1, 5 },
          { 1, pmode_t::audio_play_range, 3, 5 }
      },
      {
      ...
      {
          { 1, pmode_t::audiobook_range , 1, 5 },
          { 1, pmode_t::audiobook_range , 6, 8 }
      },

      // special2
      {
          { 1, pmode_t::audio_play_range, 1, 2 },
          { 1, pmode_t::audio_play_range, 1, 3 }
      },
      {
  ...
  for (card_data_2 data: test_data) {
    ...
    ASSERT_TRUE(SM_trovaLibre::is_in_state<StartPlay<Play>>()) << "Index: " << ind;
...
// =================== next/previous (play)
TEST_F(trovaLibre_test_fixture, next_previous_in_play_audiobook_single) {
...
TEST_F(trovaLibre_test_fixture, next_previous_in_play_audiobook) {
  const uint8_t folder = 5;
  uint8_t current_track = 2;
...
// =================== end of audiobook
TEST_F(trovaLibre_test_fixture, end_play_audiobook) {
  const uint8_t folder = 5;
...
TEST_F(trovaLibre_test_fixture, end_play_audiobook_single) {
  const uint8_t folder = 5;
  uint8_t track_count = 10;
  folderSettings card = { folder, pmode_t::audiobook_single, 0, 0 };
  getSettings().writeFolderSettingToFlash(folder, track_count); // last track
...
TEST_F(trovaLibre_test_fixture, end_play_after_1_track_audiobook_single) {
  const uint8_t folder = 5;
  uint8_t track_count = 10;
  folderSettings card = { folder, pmode_t::audiobook_single, 0, 0 };
...
TEST_F(trovaLibre_test_fixture, end_play_after_2_track_audiobook_single) {
  const uint8_t folder = 5;
  uint8_t track_count = 10;
