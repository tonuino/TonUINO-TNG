...
public:
  ...
  bool handlePause() final
  {
    LOG(modifier_log, s_debug, F("Locked::Pause -> LOCKED!"));
    return true;
  }
  bool handleNextButton() final
  {
    LOG(modifier_log, s_debug, F("Locked::NextButton -> LOCKED!"));
    return true;
  }
  bool handlePreviousButton() final
  {
    LOG(modifier_log, s_debug, F("Locked::PrevButton -> LOCKED!"));
    return true;
  }
  bool handleVolumeUp() final
  {
    LOG(modifier_log, s_debug, F("Locked::VolumeUp -> LOCKED!"));
    return true;
  }
  bool handleVolumeDown() final
  {
    LOG(modifier_log, s_debug, F("Locked::VolumeDown -> LOCKED!"));
    return true;
  }
  bool handleRFID(const nfcTagObject &)
      final
  {
    LOG(modifier_log, s_debug, F("Locked::RFID -> LOCKED!"));
    return true;
  }
...
public:
  ...
  bool handlePause() final
  {
    LOG(modifier_log, s_debug, F("ToddlerMode::Pause -> LOCKED!"));
    return true;
  }
  bool handleNextButton() final
  {
    LOG(modifier_log, s_debug, F("ToddlerMode::NextButton -> LOCKED!"));
    return true;
  }
  bool handlePreviousButton() final
  {
    LOG(modifier_log, s_debug, F("ToddlerMode::PrevButton -> LOCKED!"));
    return true;
  }
  bool handleVolumeUp() final
  {
    LOG(modifier_log, s_debug, F("ToddlerMode::VolumeUp -> LOCKED!"));
    return true;
  }
  bool handleVolumeDown() final
  {
    LOG(modifier_log, s_debug, F("ToddlerMode::VolumeDown -> LOCKED!"));
    return true;
  }
...
public:
  ...
  bool handlePreviousButton() final
  {
    LOG(modifier_log, s_debug, F("KindergardenMode::PrevButton -> LOCKED!"));
    return true;
  }
